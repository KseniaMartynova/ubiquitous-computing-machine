...
t_mkl = np.array([1.768533, 9.878052, 29.30283, 63.71094, 117.6226,
                  197.6097, 308.2544, 436.0627])
...
plt.yticks(
    ticks=[0.01, 0.025,0.05,0.09,0.16,0.3,0.5,1,1.7, 5, 10, 20, 40, 70,100,500,1000, 2500,5000, 7000,10000,15000,30000, 50000, 80000],
    labels=['0.01', '0.025','0.05','0.09','0.16','0.3','0.5','1','1.7', '5', '10', '20','40', '70','100',"500", "1 000","2500","5 000","7 000","10 000","15 000","30 000","50 000", "80 000"],
    fontsize=10
)
...
plt.scatter(n, t_numpy, color='blue', marker='^', label='NumPy ', zorder=5)
...
# Сохранение графика в PDF и JPG
plt.savefig('C:/Users/ice64/Desktop/svd_plot.pdf')
plt.savefig('svd_plot.pdf', format='pdf', bbox_inches='tight')
plt.savefig('svd_plot.jpg', format='jpg', dpi=300, bbox_inches='tight')
