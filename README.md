...
```
2. В каждом подразеделе директории [runks](runks) содержит в себе возможность запустить сборку всех контейнеров одновременно, подробнее про сборку будет ниже в подразделах. 
