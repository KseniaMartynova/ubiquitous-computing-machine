...
1. Поместим все шаги установки по ссылке выше в наш dokerfile и построим образ.
```
...
```
В результате получим время обращения матрицы и корректность выполенения операции.
