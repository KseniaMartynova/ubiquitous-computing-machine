...
```
2. Файл [build.sh](runks/build.sh) содержит в себе возможность запустить сборку всех контейнеров одновременно, подробнее про сборку будет ниже в подразделах. 
